...
const attribution =
  '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, Coded by Amit Mondal';
...
L.marker([21.1458, 79.0882]).addTo(map).bindPopup("Nagpur").openPopup();
...
for (var i = 0; i < visited.length; i++) {
  if (i == visited.length - 1) {
    L.marker(loc_visited[i], { icon: redIcon })
      .addTo(map)
      .bindPopup(visited[i])
      .openPopup();
  } else {
